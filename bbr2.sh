...
install_kernel() {
    if [[ "$environment_headers" != "true" ]]; then
        [ ! -f "linux-headers-5.4.0-rc6_5.4.0-rc6-2_amd64.deb" ] && wget --no-check-certificate -O linux-headers-5.4.0-rc6_5.4.0-rc6-2_amd64.deb "https://github.com/chimvian/bbr2/raw/master/linux-headers-5.4.0-rc6_5.4.0-rc6-2_amd64.deb"
    ...
    if [[ "$environment_image" != "true" ]]; then
        [ ! -f "linux-image-5.4.0-rc6_5.4.0-rc6-2_amd64.deb" ] && wget --no-check-certificate -O linux-image-5.4.0-rc6_5.4.0-rc6-2_amd64.deb "https://github.com/chimvian/bbr2/raw/master/linux-image-5.4.0-rc6_5.4.0-rc6-2_amd64.deb"
